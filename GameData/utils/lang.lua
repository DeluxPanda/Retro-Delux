...
if lang_eng then
    ...
    ArtistName = "Artist"
    About_Game_Text = "This game traps you in the classic Pong game while giving you the ability to customize not only the color of the ball but also player 1 and 2 and background."
...
elseif lang_swe then
    ...
    ArtistName = "Artist"
    About_Game_Text = "Det här spelet fångar dig i det klassiska Pong spelet samtidigt som du har möjlighet att anpassa bollen spelare 1 och 2 och bakgrunden."
    ColorNameYellow = "Gul"
    ColorNameGreen = "Grön"
    ColorNameRed = "Röd"
    ColorNameWhite = "Vit"
