...
if ColorSelectedForBackground == red then
...
love.graphics.setColor(white)
if ColorSelectedForBackground == green then
...
love.graphics.setColor(white)
if ColorSelectedForBackground == slategray then
...
love.graphics.setColor(white)
if ColorSelectedForBackground == white then
